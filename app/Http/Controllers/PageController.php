...
class PageController extends Controller
{
    public function mailTest(){
        Mail::to("moe603958@gmail.com")->send(new FirstMail("I'm title","I'm description"));
        return "aung p";
    }
    ...
    public function validateCheck(Request $request){
        $request->validate([
            ...
            // // "township"=>["required",Rule::in(['Bahan','Sanchaung','Tamwe','Thamine',"Hlaing"])]
